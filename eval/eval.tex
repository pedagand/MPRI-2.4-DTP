...
\begin{document}
  ...
  \begin{questionnaire}
    ...
    \singlemark{The support material (Agda code, PDF) is complete.}
               {strongly disagree}{strongly agree}
    \singlemark{The amount of offline work required is reasonable.}
               {strongly disagree}{strongly agree}
    ...
    \singlemark{How do you judge the professor pedagogical skills and investment in this course?}
               {poor}{great}
    \singlemark{How interesting did you find the topics (effects, indexing, recursion, genericity, open problems) treated during this course?}
